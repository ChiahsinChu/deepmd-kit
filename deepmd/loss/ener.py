    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs,
        ...
        add_data_requirement("modifier_coord", 3, atomic=True, must=False, high_prec=True)
        add_data_requirement("modifier_efield", 3, atomic=True, must=False, high_prec=False)
